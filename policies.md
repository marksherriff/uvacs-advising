...
If a SEAS student is in this position and wishes to proceed, they should create a course schedule plan in Stellic that shows how the degree can be finished in one year.  The student should then email [bscsdirector@virginia.edu](mailto:bscsdirector@virginia.edu) with the request, making sure to indicate the desired semester for graduation.  The program director will evaluate the schedule and the student's grades in Stellic. If the program director agrees that this plan is feasible, the program director will contact the SEAS school registrar to make the change in SIS.
